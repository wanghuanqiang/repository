...
<section style="padding-top: 52px; min-height: 553px;" tabindex="0" data-url="/m/cn/jsp-mobile/sys/landing.jsp" data-role="page" data-theme="f" class="encode_zh ui-page ui-body-f ui-page-header-fixed ui-page-active">
    ...
    <div role="main" class="ui-content" data-role="content">
        ...
        <div class="btn btn-default">
            ...
            <a data-theme="f" data-wrapperels="span" data-iconshadow="true" data-shadow="true" data-corners="true" data-role="button" href="html/App.html" class="custom-button1 ui-btn ui-shadow ui-btn-corner-all ui-btn-up-f"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">APP Store 下载</span></span></a>
        ...
        <div class="btn btn-default" style="margin-top:0.8em">
            ...
            <a class="ui-link" href="html/index.html" data-ajax="false"><div style="text-shadow: 1px 1px 1px #FFFFFF;color:#521e08;font-weight:bold;}"><span>访问电脑版</span></div></a>
