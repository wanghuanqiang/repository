            ...
            <div class="row row-narrow">
                <div class="page-sidebar">
                    <div class="sidebar-menu">
                        ...
                        <ul class="menu">
                            <li class="menu-item"><a class="menu-item-target" href="../zuizongdingdan.html">追踪订单</a></li>
                            ...
                            <li class="menu-item selected"><a class="menu-item-target" href="address.html">地址簿</a></li>
                    ...
                    <div class="page-content">
                        ...
                        <table class="table-default table-panel table-addressbook">
                            ...
                            <tr><td colspan="4" class="actions">
                                ...
                                <a href="address.html" data-toggle="modal" class="btn btn-red btn-lg">添加新地址</a>

                                <a class="btn btn-red btn-lg" href="../caidanyinpin.html">立即订餐</a>
                            </td>
                            </tr></tfoot>
                            <tbody>
                            <tr>
                                ...
                                <td class="controls">
                                    <a class="text-gray-light" href="../gerexinxi.html" title="修改"><i class="fa mcd mcd-edit icon"></i></a>
            ...
            <div class="modal-body">
                <div class="alert-content">
                    ...
                    <p>
                        ...
                        <a class="btn btn-default btn-red btn-lg text-ucase" href="address.html">下一步</a>
                    </p>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $(document).on('cartcleared.action.yes', function(event) {
            ...
            window.location = '/cn/removeAddress.html' + "?addressType=" + addressTypeStr;
        });
