    ...
    <div class="wrap container">
        ...
        <div class="main" role="main">
            ...
            <section class="home-masthead page-masthead home-section">
                ...
                <div class="panel panel-home-masthead panel-home-masthead-login">
                    ...
                    <div class="panel-body">
                        <form action="mlslogin.html" method="post" accept-charset="utf-8" role="form" id="form_login_masthead" name="form_login_masthead" class="panel-home-masthead-form" data-required-symbol="false" novalidate>
                            ...
                            <fieldset class="form-actions">
                                ...
                                <p class="action-forgot-password "><a class="action-link" href="wangjimima.html">忘记密码？</a></p>
            ...
            <section class="promotions home-section">
                <div class="row">
                    <div class="col-xs-4 text-center promotion">
                        ...
                        <p><a data-toggle="modal" href="30fen.html" target="_blank"><img class="img-block promotion-thumbnail" alt="" src="../img/home_promo_3267_home_promo_2734_MDS-banner_cn_1.jpg"></a></p>
                    ...
                    <div class="col-xs-4 text-center promotion">
                        ...
                        <p><a data-toggle="modal" href="App.html" target="_blank"><img class="img-block promotion-thumbnail" alt="" src="../img/home_promo_3268_home_promo_2735_MDS-banner_cn_2.jpg"></a></p>
            ...
            <section class="how-it-works home-section">
                ...
                <p><a href="mlslogin.html" data-target="#signin" data-toggle="modal">
